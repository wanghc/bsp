...
- 增加进入登录界面时网络超错提示 [6659873]

#### 2026-02-09 (V2.0.29)

- 增加日志保存有效天数配置 [6560171]

#### 2025-12-11(V2.0.28)

- 为浏览器增加`剪切`,`撤销`,`重做`右键菜单 [6443279]

#### 2025-12-10(V2.0.27)

- 处理关闭浏览器时偶发空白假死问题 [6453465]
...
- 浏览器增加对中文繁体、法语、葡萄牙语的支持

- 浏览器支持动态切换语言，并提供接口切换语言 [5905380]


#### 2024-11-06(V2.0.24)

- 浏览器给cefbound对象提供缩放方法 [5111523 ]
- 浏览器缩放控制在[60%~160%]范围内

#### 2024-10-28(V2.0.23)

- 中文操作系统下右键菜单COPY翻译成复制

### 2024-07-17(V2.0.22)

- 浏览器F5提示及alert等信息国际化处理（语言跟随操作系统）[4778229]
- 浏览器右键菜单中调试菜单增加控制 [4759155]
