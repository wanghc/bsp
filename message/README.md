...
| FromUserRowId  | 发送消息的用户Id  | 如果获取不到HIS用户Id, 可以传入"<span style="color:red;font-weight:bold">^姓名</span>"                       |
...
| CreateLoc      | 发送者科室        | 可以为空。传HIS中科室Id，可传"<span style="color:red;font-weight:bold">^科室描述</span>"                   |
