...
| 检验标本超时未接收 | 1355 |  EpisodeID | 病区护士 |  患者检验标本已交接运送单的超过一定时间还未接收，发消息提醒 | 
...
| 自理能力评估结果  | 1389  |   EpisodeID  | 主治医生  | 护理病历：自理能力评估表，根据评估结果给医生推送消息   |
...
| 申请病案退回绝  | 1422 | EpisodeID  | 自传 | 医生申请病案退回，当病案室拒绝时发消息给申请医生 <br>如果一定是主管医生申请，那么可以配置不需要传接收人  |
|     |      |      |                    |                                                |
